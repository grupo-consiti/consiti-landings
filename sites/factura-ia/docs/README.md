...
| Archivo | Qué es |
|---|---|
| [`HANDOFF-REBRAND-FACTUIA.md`](HANDOFF-REBRAND-FACTUIA.md) | **Rebrand Factura IA → FactuIA (para Duvan).** Dominio factuiasv.com, DNS/Cloud Run, 301, Search Console, Meta, Ads, logos pendientes |
