    ...
    vacancies: [
      {
        ...
        desc: "Vende las soluciones de Grupo Consiti a cliente final con método B2B: FactuIA, Vendi y Komandi. Prospectas, manejas objeciones y cierras, con sueldo base más comisión y una semana de capacitación intensiva para arrancar.",
        tags: ["FactuIA", "Vendi", "Komandi"],
        requirements: [
